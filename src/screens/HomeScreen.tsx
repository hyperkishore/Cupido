  ...
  useEffect(() => {
    ...
    const mockAnswers: Answer[] = [
      ...
      },
      {
        id: 'a4',
        questionId: 'q4',
        text: "Why do we say 'after dark' when it's actually 'during dark'? Language fascinates me in the weirdest ways.",
        category: 'DREAMS',
      ...
      },
      {
        id: 'a5',
        questionId: 'q5',
        text: "I remember the little things - their coffee order, the song that makes them happy, the story they told me months ago. Love is in the details.",
        category: 'RELATIONSHIPS',
      ...
      },
      {
        id: 'a6',
        questionId: 'q6',
        text: "Public speaking terrified me. I started by reading to my plants, then my pets, then finally joined a local poetry slam. Baby steps matter.",
        category: 'PERSONAL GROWTH',
